(function() {
  var Module, baseModule, cache, cacheDiffString, requestHostname, requestPath, requestPort, serverRequire,
  ...
  window.require.setRequestPath = function(path) {
    return requestPath = path.replace(/^\//, '');
  };
